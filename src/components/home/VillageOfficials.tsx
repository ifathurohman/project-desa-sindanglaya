...
const OfficialCard: React.FC<{ official: Official }> = ({ official }) => (
  <div className="bg-white rounded-lg shadow-sm p-3 w-[125px] transition-all duration-300 hover:shadow-md mx-auto">
        ...
        <div className="flex justify-center pb-4 mx-auto">
          <div className="min-w-fit p-4 mx-auto">
            ...
            >
              ...
              {/* Wilayah Dusun */}
              <TreeNode label={<div className="text-primary-600 font-semibold">Wilayah Dusun</div>}>
                <Tree
                  lineWidth="1px"
                  lineColor="rgb(35 116 65)"
                  lineBorderRadius="0"
